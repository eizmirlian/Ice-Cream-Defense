...
public class M4Tests {
    ...
    @Test
    //This test tests an enemy�s conditions for death, 
    //either being that they have no more health or if they attack the monument they will be deleted. 
    //This is important because we need to ensure 
    //that once the ability for towers to attack enemies is correctly implemented, 
    //these enemies will die/be deleted given the correct commands to ensure that they function as intended.
