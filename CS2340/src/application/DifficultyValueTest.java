...
public class DifficultyValueTest {
    ...
    public void ethanDifficultyValue() {
        ...
        Assert.assertEquals("Money: 250", "Money: " + (50 * (homeScreen.setModifier(easy) + 1)));
        Assert.assertEquals("Money: 200", "Money: " + (50 * (homeScreen.setModifier(medium) + 1)));
        Assert.assertEquals("Money: 150", "Money: " + (50 * (homeScreen.setModifier(hard) + 1)));
        Assert.assertEquals("Money: 50", "Money: " + (50 * (homeScreen.setModifier(null) + 1)));
    }
}