...
public class ConfigEventHandler implements EventHandler<ActionEvent> {
    ...
    private void levelGen(Difficulty diff) {
        ...
        String levelLayout1 = "....0......0..."
                            ...
                            + "oo............v"
                            + "oo<<<<<<<<<<<<<";
        EnemyType[][] levelWaves1 = {{EnemyType.MEDIUM, EnemyType.MEDIUM, EnemyType.MEDIUM}, {EnemyType.HEAVY, EnemyType.LIGHT, EnemyType.LIGHT}};
        Level level1 = new Level(levelLayout1, diff, levelWaves1, 15, 15, primaryStage, 1500, 1200);
        level1.generateLevel();
        level1.makeWaves(movingSprites);
